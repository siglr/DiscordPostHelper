...
#Region "Subs and functions"
    ...
    Private Function StageManualFiles(flightPlanPath As String, weatherPath As String) As Tuple(Of String, String)
        ...
        Return New Tuple(Of String, String)(stagedPln, stagedWpr)
    ...
    Private Sub HandleManualFileCombination(files As IEnumerable(Of String))
        ...
        If String.IsNullOrWhiteSpace(wprPath) Then
            ...
            plnPath = manualResult.FlightPlanPath
            wprPath = manualResult.WeatherPath
            trackerGroup = manualResult.TrackerGroupName
        End If

        If String.IsNullOrWhiteSpace(wprPath) Then
            Using New Centered_MessageBox(Me)
                MessageBox.Show(Me, "A weather preset (.wpr) is required to continue.", "Missing weather preset", MessageBoxButtons.OK, MessageBoxIcon.Information)
            End Using
            Return
        End If

        LoadManualSelection(plnPath, wprPath, trackerGroup, taskData, Path.GetFileName(plnPath))
    End Sub
